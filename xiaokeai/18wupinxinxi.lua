...
--显示三维
GLOBAL.MOD_ITEMINFO.SHOW_EDIBLE_SHANG = TUNING.xiaoyao("SHOW_EDIBLE_SHANG")
--显示新鲜度
GLOBAL.MOD_ITEMINFO.SHOW_PERISHABLE_SHANG = TUNING.xiaoyao("SHOW_PERISHABLE_SHANG")

GLOBAL.MOD_ITEMINFO.SHOW_PREFABNAME = TUNING.xiaoyao("SHOW_PREFABNAME")
GLOBAL.MOD_ITEMINFO.SHOW_BACKGROUND = TUNING.xiaoyao("SHOW_BACKGROUND")

GLOBAL.MOD_ITEMINFO.WURT_MEAT = TUNING.xiaoyao("WURT_MEAT")
GLOBAL.MOD_ITEMINFO.WIG_VEGGIE = TUNING.xiaoyao("WIG_VEGGIE")
GLOBAL.MOD_ITEMINFO.WORM_HEALTH = TUNING.xiaoyao("WORM_HEALTH")

GLOBAL.MOD_ITEMINFO.INFO_SCALE = TUNING.xiaoyao("INFO_SCALE")
GLOBAL.MOD_ITEMINFO.EQUIP_SCALE = TUNING.xiaoyao("EQUIP_SCALE")

GLOBAL.MOD_ITEMINFO.PERISHABLE = TUNING.xiaoyao("PERISHABLE")
GLOBAL.MOD_ITEMINFO.PERISH_DISPLAY = {PERISH_ONLY = 0, STALE_PERISH = 1, BOTH = 2}

GLOBAL.MOD_ITEMINFO.TIME_FORMAT = TUNING.xiaoyao("TIME_FORMAT")
...
GLOBAL.MOD_ITEMINFO.MARGINH = TUNING.xiaoyao("HORIZONTAL_MARGIN")
GLOBAL.MOD_ITEMINFO.MARGINV = TUNING.xiaoyao("VERTICAL_MARGIN")
...
local SHOW_INFO_HANDS = TUNING.xiaoyao("SHOW_INFO_HANDS")
local SHOW_INFO_BODY = TUNING.xiaoyao("SHOW_INFO_BODY")
local SHOW_INFO_HEAD = TUNING.xiaoyao("SHOW_INFO_HEAD")
