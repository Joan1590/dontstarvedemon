...
local obc_viewMode = TUNING.xiaoyao("OBC_INITIAL_VIEW_MODE")
...
GLOBAL.TheInput:AddKeyUpHandler(TUNING.xiaoyao("OBC_FUNCTION_KEY_1"), ChangeViewMode)
GLOBAL.TheInput:AddKeyUpHandler(TUNING.xiaoyao("OBC_FUNCTION_KEY_2"), ShowOrHideHUD)
GLOBAL.TheInput:AddKeyUpHandler(TUNING.xiaoyao("OBC_FUNCTION_KEY_3"), ShowOrHidePlayer)
GLOBAL.TheInput:AddKeyUpHandler(TUNING.xiaoyao("OBC_SWITCH_KEY_1"), ChangeCameraTarget)
GLOBAL.TheInput:AddKeyUpHandler(TUNING.xiaoyao("OBC_SWITCH_KEY_2"), ChangeCameraPosition)
GLOBAL.TheInput:AddKeyUpHandler(TUNING.xiaoyao("OBC_RESET_KEY"), ResetCameraTarget)
