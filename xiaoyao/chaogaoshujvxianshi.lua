...
local SHOWSTATNUMBERS = true			---显示三围
local SHOWDETAILEDSTATNUMBERS = SHOWSTATNUMBERS == "Detailed"
local SHOWMAXONNUMBERS = true
local SHOWCLOCKTEXT = true ~= false
local SHOWTEMPERATURE = true		--------还是开
local SHOWNAUGHTINESS = true		----淘气值
local SHOWWORLDTEMP = true				----开着吧！
local SHOWTEMPBADGES = true				---------开着吧
local SHOWBEAVERNESS = true			----没明白 开着！
local HIDECAVECLOCK = true			----开着 洞穴时钟
local SHOWMOON = GetModConfigData("SHOWMOON")
local SHOWMOONDAY = SHOWMOON > 1
local SHOWMOONDUSK = SHOWMOON > 0
local SHOWWANINGMOON = true				---------月显示
local SHOWNEXTFULLMOON = true			-----预测满月
