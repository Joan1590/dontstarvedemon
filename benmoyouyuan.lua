...
function ApplyLocalizedFonts()
	...
	table.insert(LocalizedFontAssets, _G.Asset("FONT", MODROOT.."fonts/normal1.zip"))
	table.insert(LocalizedFontAssets, _G.Asset("FONT", MODROOT.."fonts/normal1_outline.zip"))
	...
	_G.TheSim:LoadFont(MODROOT.."fonts/normal1.zip", "normalfont")
	_G.TheSim:LoadFont(MODROOT.."fonts/normal1_outline.zip", "normalfont_outline")
